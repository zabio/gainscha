...
public class SampleCodeActivity extends Activity implements CallbackInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //使用数组作为数据源
        final String arr[] = new String[]{"GBK", "GB2312", "UTF-8", "UTF-16", "ASCII", "BIG5", "ISO-8859-1"};
        // adapter对象
        ...
        try {
            ...
            if (m_Device.isDeviceOpen() == true) {
                ...
                if (err == ERROR_CODE.SUCCESS) {
                    ...
                    byte[] bs = sendString.getBytes(mEncode);
                    ...
                    if (m_Device.isDeviceOpen()) {
                        ...
                        err = m_Device.printString(stringBuffer.toString(), font, bold, underlined, doubleHeight, doubleWidth);
